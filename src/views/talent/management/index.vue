<template>
  <div class="app-container">
    ...
    <el-table :key="tableKey" v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%; margin-top:1rem;" height="calc(50vh - 164px)">
      <el-table-column prop="level" label="等级" align="center" min-width="20%"></el-table-column>
    ...
    <div class="filter-container">
      <el-tag>达人今日分红详情</el-tag>
      <el-input v-model="editQuery.lv" size="mini" style="width:8rem;margin-right:1rem;margin-left:2rem" placeholder="达人等级" @keyup.enter.native="queryDetailListByParam()"></el-input>
      <el-input v-model="editQuery.name" size="mini" style="width:8rem;margin-right:1rem;margin-left:2rem" placeholder="达人姓名" @keyup.enter.native="queryDetailListByParam()"></el-input>
      <el-input v-model="editQuery.userPhone" size="mini" style="width:8rem;margin-right:1rem;margin-left:2rem" placeholder="达人号码" @keyup.enter.native="queryDetailListByParam()"></el-input>
    ...
    <el-table :key="DetailTableKey" v-loading="DetailListLoading" :data="DetailList" border fit highlight-current-row style="width: 100%; margin-top:1rem;" height="calc(50vh - 164px)">
      <el-table-column prop="userPhone" label="手机号码" align="center" min-width="20%"></el-table-column>
      <el-table-column prop="title" label="达人姓名" align="center" min-width="20%"></el-table-column>
      <el-table-column prop="content" label="达人等级" align="center" min-width="20%"></el-table-column>
      <el-table-column prop="content" label="今日分红" align="center" min-width="20%"></el-table-column>
      <el-table-column prop="content" label="总共分红" align="center" min-width="20%"></el-table-column>
    </el-table>
...
export default {
  ...
  methods: {
    queryDetailListByParam(isAll) {
      ...
      this.listQueryDetail.lv = this.editQuery.lv;
      this.listQueryDetail.name = this.editQuery.name;
      this.listQueryDetail.userPhone = this.editQuery.userPhone;
      this.listQueryDetail.page = 1;
